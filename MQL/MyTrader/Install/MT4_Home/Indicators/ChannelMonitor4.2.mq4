...
//----
   ...
   WriteText(StringFormat("Channel Width=%4.0f ; Current Pos=%2.0f%% ; Current Spread=%4.1f",NormalizeDouble((chMax-chMin)*pScale,1),NormalizeDouble(100*(Bid-chMin)/(chMax-chMin),0), NormalizeDouble(pScale*(Ask-Bid),1) )); 
